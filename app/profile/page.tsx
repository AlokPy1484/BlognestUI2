    ...
    return(
        <div className="flex flex-col justify-start items-start gap-8  w-full">
            <Image src="https://images.unsplash.com/photo-1607453361165-c629a0d1839d?q=80&w=2848&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
                ...
                width={1200}
                height={20}/>
            <div className="flex flex-col justify-start items-start gap-8 w-full px-20">
            <div className="flex flex-col justify-start items-start w-full gap-4">
                <div className="flex flex-col justify-start items-start w-full">
                    <div className="flex justify-between items-center w-full">
                        <div className="flex justify-start items-center gap-4">
                        <Image src={"https://devwithalok.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FHero1.d3a1a1c3.jpg&w=128&q=75"}
                            alt="Profile Picture"
                            width={100}
                            height={100}
                            className="rounded-full p-1 bg-black/10"/>
                        <div className="flex flex-col justify-between items-start gap-1">
                            <h1 className="text-[18px] font-bold">Jack Danial</h1>
                            <a className="text-xs text-black/70"> 2.1K friends</a>
                            <div>
                                <AvatarGroup className="gap-1">
                                <Avatar size="sm">
                                ...
                                <Avatar size="sm">
                                    ...
                                    <Avatar size="sm">
                                    <AvatarImage
                                    src="https://github.com/alokpy1484.png"
                                    alt="@evilrabbit"
                                    />
                                    <AvatarFallback>ER</AvatarFallback>
                                </Avatar>
            ...
            <div className="flex justify-start items-center gap-8 font-extralight py-2 border-b w-full">
                <a>Home</a>
                <a>Activity</a>
                <a>Saved</a>
            </div>
