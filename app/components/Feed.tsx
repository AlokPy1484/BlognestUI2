...
import { BlogFeedCard } from "./BlogFeedCardSmall";
...
const BlogListing = [
    ...
    return(
        <div className="flex flex-col justify-start items-start gap-8 mx-8 mt-4 w-full h-full">
            <div className="flex justify-start items-center gap-4">
                <Button variant={"ghost"} className="border-b-zinc-200 rounded-none">For you</Button>
