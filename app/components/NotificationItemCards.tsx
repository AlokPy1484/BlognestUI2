...
export function BlogCreatedCard(){
    ...
    return(
        <div className="flex justify-start items-start gap-4 w-full">
            ...
            <a className="text-sm text-black/60">32 min ago</a>
            </div>
        </div>
    )
}
...
export function CommentCard(){
    ...
    return(
        <div className="flex justify-start items-start gap-4 w-full">
            ...
            <div className="border border-black/10 p-2 rounded-md text-sm font-medium line-clamp-2 leading-loose">
...
export function BlogLikedCard(){
    ...
    return(
        <div className="flex justify-start items-start gap-4 w-full">
            ...
            <div className="flex justify-start border border-black/10 p-2 rounded-md text-sm gap-4 font-semibold">
